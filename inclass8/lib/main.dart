...
import 'package:inclass8/models/folder.dart';
import 'package:inclass8/repositories/card_repository.dart';
import 'package:inclass8/repositories/folder_repository.dart';

void main() {
  runApp(const FoldersScreen());
}
